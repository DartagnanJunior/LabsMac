                        ...
                        <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:w-1/2 lg:text-left">
                                ...
                                <p className="mt-8 max-w-2xl text-pretty text-lg">
                                    Laboratório especializado em análises clínicas com tecnologia de ponta e resultados precisos para cuidar da sua saúde.
                                </p>
                    ...
                    <div className="group relative m-auto max-w-6xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            <div className="md:max-w-44 md:border-r md:pr-6">
                                <p className="text-end text-sm">Confiado por profissionais e pacientes</p>
                            </div>
                            <div className="relative py-6 md:w-[calc(100%-11rem)]">
                                <InfiniteSlider
                                    ...
                                    gap={112}>
                                    <div className="flex">
                                        <div className="mx-auto h-5 w-fit dark:invert flex items-center justify-center">
                                            <span className="text-sm font-semibold">CRM-SP</span>
                                        </div>
                                    </div>
                                    <div className="flex">
                                        <div className="mx-auto h-5 w-fit dark:invert flex items-center justify-center">
                                            <span className="text-sm font-semibold">CFM</span>
                                        </div>
                                    </div>
                                    <div className="flex">
                                        <div className="mx-auto h-5 w-fit dark:invert flex items-center justify-center">
                                            <span className="text-sm font-semibold">ANVISA</span>
                                        </div>
                                    </div>
                                    <div className="flex">
                                        <div className="mx-auto h-5 w-fit dark:invert flex items-center justify-center">
